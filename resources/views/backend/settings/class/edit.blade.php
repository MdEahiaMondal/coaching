                            ...
                            <tr>
                                <td>
                                    <div class="form-group row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $class->class_name }}" id="className" placeholder="Write class Name here" required>
                                            @error('name')
