        ...
        <div class="row content login-form">
            <div class="col-12 pl-0 pr-0">
                <div class="form-group">
                    <div class="col-sm-12">
                        <h4 class="text-center font-weight-bold font-italic mt-3">User Edit Info Form</h4>
                    </div>
                </div>
                <form method="POST" action="{{ route('user-info-update',['user'=>$user->id]) }}" enctype="multipart/form-data" autocomplete="off" class="form-inline">
                    @csrf
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <input id="mobile" type="text" class="col-sm-9 form-control @error('mobile') is-invalid @enderror" name="mobile" value="{{ $user->mobile }}" placeholder="8801yyyyyy" required autofocus>
                        @error('mobile')
                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
