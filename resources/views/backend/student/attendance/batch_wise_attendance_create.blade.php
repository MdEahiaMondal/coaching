            ...
            <div class="row content">
                <div class="col-md-8 offset-md-2 pl-0 pr-0">
                    <div class="form-group">
                        <div class="col-sm-12">
                            <h4 class="text-center font-weight-bold font-italic mt-3">Students Attendance create</h4>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group row mr-2">
                                <select name="academic_session" class="form-control" id="academicSession" required autofocus>
